...
<head>
    ...
    <title>Login Aplikasi Kasir | Ambhada Dhafa</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      ...
      <p class="mt-3 mb-3 text-white">&copy; 2023 Developed by -  <a target="_blank" rel="noopener noreferrer" href="siap.pranataindonesia.ac.id" class="text-white">
     Ambadha Dhafa Ganiesa Nugroho</a></p>
    </form>
